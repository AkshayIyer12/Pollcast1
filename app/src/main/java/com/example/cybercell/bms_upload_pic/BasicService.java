...
public interface BasicService {
    ...
    @GET("/GetUserDetails")
    void getuserdetails(@Query("userid") String uid, @Query("password") String pass, Callback<List<LoginData>> callback);
//    @GET("/GetDistrictJSON")
//    public void getArrayWithObjects(Callback<List<Basic>> callback);
      @GET("/GetAssemblyJSON")
      void getassemblywithdistrict(@Query("dis_no") String dis, Callback<List<Assembly>> callback);
    @GET("/GetPSJSON")
    void getpollingstation(@Query("dis_id") String dis, @Query("ass_id") String assemb, Callback<List<PollingStation>> callback);
//    @GET("/GetRecordJSON")
